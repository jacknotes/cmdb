...
type Resource struct {
	...
	// 资源元数据信息，固有属性，如云商
	// @gotags: josn:"base"
	Base *Base `protobuf:"bytes,1,opt,name=base,proto3" json:"base,omitempty" josn:"base"`
	// 资源信息，通用信息，允许变化，比如ip
...
var file_apps_resource_pb_resource_proto_rawDesc = []byte{
	...
	0x70, 0x65, 0x22, 0x34, 0x0a, 0x0f, 0x51, 0x75, 0x65, 0x72, 0x79, 0x54, 0x61, 0x67, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x21, 0x0a, 0x0c, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0b, 0x72, 0x65, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x64, 0x73, 0x22, 0x8d, 0x01, 0x0a, 0x10, 0x55, 0x70, 0x64,
	...
	,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x22, 0x46, 0x0a, 0x0c, 0x53, 0x68, 0x61, 0x72, 0x65, 0x64, 0x50, 0x6f,
	...
	0x75, 0x72, 0x63, 0x65, 0x42, 0x29, 0x5a, 0x27, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
	0x6f, 0x6d, 0x2f, 0x6a, 0x61, 0x63, 0x6b, 0x6e, 0x6f, 0x74, 0x65, 0x73, 0x2f, 0x63, 0x6d, 0x64,
...
var file_apps_resource_pb_resource_proto_goTypes = []interface{}{
	...
	(*QueryTagRequest)(nil),     // 7: course.cmdb.resource.QueryTagRequest
	(*UpdateTagRequest)(nil),    // 8: course.cmdb.resource.UpdateTagRequest
	(*ResourceSet)(nil),         // 9: course.cmdb.resource.ResourceSet
	(*Resource)(nil),            // 10: course.cmdb.resource.Resource
	(*SharedPolicy)(nil),        // 11: course.cmdb.resource.SharedPolicy
	(*Base)(nil),                // 12: course.cmdb.resource.Base
	(*Information)(nil),         // 13: course.cmdb.resource.Information
	(*TagSet)(nil),              // 14: course.cmdb.resource.TagSet
...
var file_apps_resource_pb_resource_proto_depIdxs = []int32{
	...
	0,  // 5: course.cmdb.resource.UpdateTagRequest.action:type_name -> course.cmdb.resource.UpdateAction
	15, // 6: course.cmdb.resource.UpdateTagRequest.tags:type_name -> course.cmdb.resource.Tag
	10, // 7: course.cmdb.resource.ResourceSet.items:type_name -> course.cmdb.resource.Resource
	12, // 8: course.cmdb.resource.Resource.base:type_name -> course.cmdb.resource.Base
	13, // 9: course.cmdb.resource.Resource.information:type_name -> course.cmdb.resource.Information
	1,  // 10: course.cmdb.resource.Base.vendor:type_name -> course.cmdb.resource.Vendor
	2,  // 11: course.cmdb.resource.Base.resource_type:type_name -> course.cmdb.resource.Type
	3,  // 12: course.cmdb.resource.Base.usage_mode:type_name -> course.cmdb.resource.UsageMode
	11, // 13: course.cmdb.resource.Base.shared_policy:type_name -> course.cmdb.resource.SharedPolicy
	15, // 14: course.cmdb.resource.Information.tags:type_name -> course.cmdb.resource.Tag
	15, // 15: course.cmdb.resource.TagSet.items:type_name -> course.cmdb.resource.Tag
	...
	7,  // 19: course.cmdb.resource.Service.QueryTag:input_type -> course.cmdb.resource.QueryTagRequest
	8,  // 20: course.cmdb.resource.Service.UpdateTag:input_type -> course.cmdb.resource.UpdateTagRequest
	9,  // 21: course.cmdb.resource.Service.Search:output_type -> course.cmdb.resource.ResourceSet
	14, // 22: course.cmdb.resource.Service.QueryTag:output_type -> course.cmdb.resource.TagSet
	10, // 23: course.cmdb.resource.Service.UpdateTag:output_type -> course.cmdb.resource.Resource
